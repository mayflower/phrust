# Phase 6 Array Callback Functions

Prompt 06.18 implements the PHP-visible array callback helper MVP on top of the
...
- `PHASE6-GAP-ARRAY-WALK-BY-REF-MUTATION`: `array_walk` does not yet pass
