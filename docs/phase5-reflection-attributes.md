# Phase 5 Reflection and Attributes

Phase 5 carries attribute and declaration metadata from the existing frontend
...
Attribute entries are produced by Phase 3 semantic lowering, transported
...
`false`; comment retention is not part of the Phase 5 IR metadata contract.
...
Phase 6 should build on these existing public data structures rather than
...
Phase 6 should treat Reflection as a compatibility feature, not just metadata
