# Phase 5 Reference and Copy-on-Write Model

Phase 5 separates PHP values from storage locations so references, array
...
write instruction, Phase 5 fixtures document that limitation explicitly.
...
Phase 6 reference and COW work should reuse:
...
Reference writes and array COW separation sit on hot VM paths. Phase 6 should
