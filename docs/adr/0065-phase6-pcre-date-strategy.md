# ADR-0065: Phase 6 PCRE and Date Strategy
...
Phase 6 permits narrow dependencies for PCRE2/tzdata-style compatibility when
...
For Prompt 06.34, Date/Time starts with a small Rust-owned abstraction rather
...
Prompt 06.35 extends that abstraction with deterministic timestamp formatting,
