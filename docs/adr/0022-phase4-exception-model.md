# ADR 0022: Phase 4 Exception Model
...
Phase 4 needs `throw`, `try`, `catch`, and `finally` behavior for executable
...
- Phase 5 can replace or extend the internal exception object without changing
