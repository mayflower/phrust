# ADR-0030: Runtime semantics Generator and Fiber Control Flow
...
exceptions. Runtime had no continuation model. Runtime semantics needs real runtime
...
performance-sensitive. Standard library should optimize continuation storage only after
