# ADR-0070: Phase 7 Performance Scope
...
Phase 7 follows the Phase 0 through Phase 6 PHP 8.5.7 Rust engine work. The
...
fibers, reflection MVPs, include/autoload basics, and a Phase 6 standard library
surface.

The Phase 7 goal is to add performance infrastructure and conservative
...
Phase 7 introduces these layers, in order:
...
- No new standard-library or extension compatibility phase.
...
- Known gaps must be recorded in `docs/known-gaps-phase7.md` with evidence.
...
- The implementation requires broad rewrites outside the Phase 7 layer.

## Consequences

Phase 7 prioritizes measurable infrastructure and correctness evidence over
