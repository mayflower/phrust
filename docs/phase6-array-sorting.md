# Phase 6 Array Sorting Functions

Prompt 06.19 implements deterministic MVP sorting helpers:
...
- `PHASE6-GAP-NATURAL-SORT-EDGE-CASES`: natural sorting is not byte-perfect for
