...
Phase 3 scopes describe compile-time nesting and context. They are not runtime
...
`$this`, `self`, `parent`, and `static` require later context checks. Prompt 12
...
runtime capture evaluation are later phases unless a Phase 3 fixture explicitly
requires them.
