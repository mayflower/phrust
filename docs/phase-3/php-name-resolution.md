...
Phase 3 implements PHP source-level name normalization and import resolution
for a single analyzed file.

## Prompt 09 Name Model
...
top of the Prompt 09 model. `NameKind::Function` therefore also uses ASCII
