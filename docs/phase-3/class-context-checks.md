...
Prompt 26 adds semantic checks that are decidable from the current source file
...
PHP 8.5 lint accepts `$this` inside static methods and static closures. Phase 3
...
Prompt 26 fixtures live under `fixtures/semantic/classes/`:
