...
Phase 3 declaration collection builds per-file declarations from AST views and
...
## Prompt 08 Namespace Collection
...
## Prompt 11 Declaration Registration
...
conditional declaration execution are outside Phase 3.
