...
from the Phase 3 type-lowering pass.
...
Prompt 25 adds `FunctionLikeFlags` for:
...
Default values are only source references in Phase 3. They are marked as
...
closure-use duplicate validation. Prompt 25 also covers void/never returns,
