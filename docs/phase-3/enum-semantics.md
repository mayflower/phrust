...
Prompt 24 lowers PHP enum cases into dedicated HIR records without executing
...
they require value-level checks beyond the current Phase 3 constant-expression
surface.
