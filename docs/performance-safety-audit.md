...
`docs/safety-audit-cranelift.md`.
...
boundary and must stay covered by `docs/safety-audit-cranelift.md`,
...
- New Cranelift native-boundary `unsafe`: document it in
  `docs/safety-audit-cranelift.md`, keep `jit-cranelift` default-off,
