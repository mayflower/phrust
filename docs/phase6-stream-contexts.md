# Phase 6 Stream Functions and Contexts MVP

Reference target: PHP 8.5.7 (`php-8.5.7`).

Prompt 06.31 adds Composer-facing stream metadata, stream copy/content helpers,
...
`stream_isatty` returns deterministic `false` for Phase 6 streams; host TTY
