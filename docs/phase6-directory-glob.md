# Phase 6 Directory and Glob MVP

Reference target: PHP 8.5.7 (`php-8.5.7`).

Prompt 06.30 adds directory resources and deterministic local directory/glob
helpers on top of the Phase 6 filesystem capability model.
