# Phase 6 Formatted Output Helpers

Reference target: PHP 8.5.7 (`php-8.5.7`).

Prompt 06.15 implements a deterministic formatting MVP for `printf`,
...
- `PHASE6-GAP-PRINTF-ADVANCED-FORMATS`
- `PHASE6-GAP-FPRINTF-STREAM-RESOURCE`
