# Phase 6 Encoding, Hash, HTML, and URL Helpers

Reference target: PHP 8.5.7 (`php-8.5.7`).

Prompt 06.14 adds pragmatic standard-library helpers for binary/hex,
...
- `PHASE6-GAP-HTML-FULL-ENTITIES-FLAGS`
- `PHASE6-GAP-HTTP-BUILD-QUERY-OPTIONS`
- `PHASE6-GAP-HASH-RANDOM-ALGORITHMS`
