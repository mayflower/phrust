# Phase 9 Generated PHPTs

Phase 9 generated tests are derived from Original PHPTs in the pinned php-src
...
```bash
nix develop -c just phpt-generate-phase9 MODULE=zend.basic
```

Run the generated module batch against Reference PHP and Target PHP:

```bash
nix develop -c just phpt-module-phase9 MODULE=zend.basic
```
