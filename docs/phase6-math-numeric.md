# Phase 6 Math and Numeric Functions

Reference target: PHP 8.5.7 (`php-8.5.7`).

Prompt 06.20 implements the common standard math and numeric helpers used by
...
Prompt 06.20 is covered by:

- runtime unit tests in `php_runtime::builtins`
- registry metadata tests in `php_std`
- `tests/fixtures/phase6/_harness/stdlib/math_numeric.php`
- known-gap fixture
  `tests/fixtures/phase6/_harness/stdlib/math_numeric_float_edges.php`
- `just diff-stdlib`
- `just test-phase6`
- `just verify-phase6`
