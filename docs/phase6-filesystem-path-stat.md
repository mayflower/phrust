# Phase 6 Filesystem Path and Stat MVP

Reference target: PHP 8.5.7 (`php-8.5.7`).

Prompt 06.28 adds PHP-visible path helpers and a capability-gated stat MVP.
Prompt 06.29 extends the same capability model to file I/O; see
`docs/phase6-file-io.md`.
...
request-lifetime invalidation model; later filesystem prompts can add a request
...
field. This is tracked as `PHASE6-GAP-STAT-BYTE-PERFECT`.
