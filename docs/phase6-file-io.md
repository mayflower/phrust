# Phase 6 Filesystem File I/O MVP

Reference target: PHP 8.5.7 (`php-8.5.7`).

Prompt 06.29 adds PHP-visible file and stream-handle operations on top of the
Phase 6 resource model and capability-gated local file wrapper.
