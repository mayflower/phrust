...
| Strings | `string_concats, concat_prealloc_hits, string_allocations` | 1114 | `tests/fixtures/performance/perf_smoke/stdlib_dispatch.php` (182) | complete_for_current_counter_set |
...
| ---: | --- | --- | --- | --- | --- | --- |
| 1 | Runtime Allocation | 1643 counted event(s) in tests/fixtures/performance/perf_smoke/array_fast_paths_v2.php | runtime value, container, frame/register, and literal-pool allocation pressure | references, COW, destructor order, and request-local lifetime are observable | destructor, reference, COW, frame reuse, and literal interning fixtures | high |
