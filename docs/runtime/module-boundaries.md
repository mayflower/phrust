...
| Native execution and instrumentation | `native_ops`, `jit_array`, `layout_stats`, `numeric_string`, `runtime_memory` | Typed native operation/helper contracts, counters, audited memory access, and measurement-only metadata |
