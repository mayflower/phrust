...
| `E_PHP_RUNTIME_NUMERIC_STRING_MATRIX` | arrays and array-key conversion | high | high | `fixtures/runtime/valid/scalars/expressions.php`, `fixtures/runtime_semantics/comparisons/array-loose-strict.php`, `fixtures/runtime_semantics/comparisons/elvis-branch-condition-register-reuse.php`, and 14 more |
