# Phase 6 PCRE Extension
Reference target: PHP 8.5.7 (`php-8.5.7`).

Prompt 06.33 implements an ext/pcre MVP backed by PCRE2:
...
- `PHASE6-GAP-PCRE-ADVANCED-FLAGS`
- `PHASE6-GAP-PCRE-CALLBACK-DISPATCH`
- `PHASE6-GAP-PCRE-LAST-ERROR-VM-PERSISTENCE`
