...
This document is an engineering policy for Foundation. It is not legal advice.
...
## Allowed Foundation Artifacts

Foundation may store:
...
part of Foundation. Any later code or test import from `php-src` needs an explicit
license and provenance review.

If later layers import code, tests, or substantial derived material from
...
No vendored `php-src` copy is committed in Foundation.
