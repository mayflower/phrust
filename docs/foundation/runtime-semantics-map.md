...
Foundation records the runtime compatibility surface for PHP `8.5.7`. It does not
implement runtime values, object layouts, execution, extensions, or VM behavior.

## 1. Value Model

Later layers must account for:
...
Foundation only records this surface. Extension implementation belongs to later
layers.
...
| Area | Compatibility risk | Implementation risk | Testability | Later layer |
| --- | --- | --- | --- | --- |
