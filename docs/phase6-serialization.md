# Phase 6 Serialization MVP

Reference target: PHP 8.5.7 (`php-8.5.7`).

Prompt 06.11 implements bounded `serialize` and `unserialize` support for:
...
Known gaps are tracked in `docs/known-gaps-phase6.md`: `allowed_classes`,
