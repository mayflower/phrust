# Phase 7 Local Slot Layout

Prompt 07.36 is implemented on top of the existing Phase 4 VM frame model.
...
These operations do not perform a name hash lookup. Phase 7 adds explicit
...
- `extract` and `compact` are not implemented as VM builtins in this phase.
