# Phase 6 INI Config MVP

Reference target: PHP 8.5.7 (`php-8.5.7`).

Prompt 06.22 adds a deterministic request-local INI registry. The VM seeds it
...
remote paths remain outside this prompt and continue to fail deterministically.
