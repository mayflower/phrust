...
Lexer lexer fixtures live in `tests/fixtures/lexer`.
...
- `just lexer-fixtures`: same strict comparison used by the Lexer gate.
...
differences must be recorded in `docs/lexer/known-lexer-differences.md` and
