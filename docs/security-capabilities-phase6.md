...
Phase 6 adds standard-library and Composer-facing APIs without widening host
...
Prompt 06.48 registers those process/shell names so Composer-style probes see a
...
Local file APIs added in Prompt 06.29 (`fopen`, `file_get_contents`,
...
Directory APIs added in Prompt 06.30 (`opendir`, `scandir`, `glob`, and
...
Stream helpers added in Prompt 06.31 preserve context options locally and keep
