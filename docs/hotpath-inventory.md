...
| --- | --- | ---: | --- | --- |
| Dispatch | `instructions_executed` | 1832 | `tests/fixtures/performance/perf_smoke/array_fast_paths_v2.php` (870) | complete_for_current_counter_set |
...
| Strings | `string_concats, concat_prealloc_hits, string_allocations` | 1341 | `tests/fixtures/performance/perf_smoke/array_fast_paths_v2.php` (292) | complete_for_current_counter_set |
...
| ---: | --- | --- | --- | --- | --- | --- |
| 1 | Runtime Allocation | 3170 counted event(s) in tests/fixtures/performance/perf_smoke/array_fast_paths_v2.php | runtime value, container, frame/register, and literal-pool allocation pressure | references, COW, destructor order, and request-local lifetime are observable | destructor, reference, COW, frame reuse, and literal interning fixtures | high |
...
| 4 | Strings | 292 counted event(s) in tests/fixtures/performance/perf_smoke/array_fast_paths_v2.php | string concatenation allocation and conversion fast paths | PHP scalar conversion and binary-safe string behavior must stay exact | concat, scalar conversion, encoding-neutral, and error-order fixtures | high |
