...
| Strings | `string_concats, concat_prealloc_hits, string_allocations` | 817 | `tests/fixtures/performance/perf_smoke/array_fast_paths_v2.php` (136) | complete_for_current_counter_set |
