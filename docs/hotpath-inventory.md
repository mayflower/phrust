...
| ---: | --- | --- | --- | --- | --- | --- |
| 1 | Runtime Allocation | 2184 counted event(s) in tests/fixtures/performance/perf_smoke/array_fast_paths_v2.php | runtime value, container, frame/register, and literal-pool allocation pressure | references, COW, destructor order, and request-local lifetime are observable | destructor, reference, COW, frame reuse, and literal interning fixtures | high |
