...
| --- | --- | ---: | --- | --- |
| Dispatch | `instructions_executed` | 1986 | `tests/fixtures/performance/perf_smoke/stdlib_dispatch.php` (374) | complete_for_current_counter_set |
...
| Output | `output_bytes, output_buffer_appends, output_buffer_flushes` | 342 | `tests/fixtures/performance/perf_smoke/output_writes.php` (93) | complete_for_current_counter_set |
...
| ---: | --- | --- | --- | --- | --- | --- |
| 1 | Dispatch | 374 counted event(s) in tests/fixtures/performance/perf_smoke/stdlib_dispatch.php | interpreter dispatch and bytecode layout | changing dispatch can reorder side effects or diagnostics | runtime fixture diff plus bytecode snapshots for the same fixture family | high |
