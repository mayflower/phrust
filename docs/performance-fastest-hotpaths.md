...
| ---: | --- | ---: | --- | --- | --- |
| 1 | Optimizer And Runtime Allocation | 792780 | `very_high` | `target/performance/app-flows/runs/collection_transform_pagination/phrust-fast-preset/iter-0.counters.json` via `counter-json` (189722) | Destructor, reference, COW, output-order, and verifier-bracketed optimizer fixtures. |
...
| 7 | Native And JIT Candidates | 411 | `medium` | `target/performance/app-flows/runs/dependency_container_resolution/phrust-fast-preset/iter-0.counters.json` via `counter-json` (117) | Feature-gated JIT rows with interpreter fallback, compile-budget, and side-exit reports. |
