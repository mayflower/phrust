...
require_file docs/phase4-runtime-contract.md
require_file docs/phase4-runtime-values.md
require_file docs/phase4-vm.md
require_file docs/phase4-ir.md
require_file docs/phase4-runtime-reference.md
require_file docs/phase4-reference-diff.md
require_file docs/phase4-supported-subset.md
require_file docs/phase4-known-gaps.md
require_file docs/handoff-phase5.md
require_file docs/research/zend-opcode-mapping-phase4.md
require_file docs/research/embedding-spike.md
require_file docs/research/phase4-bench-smoke.md
require_file docs/adr/0017-phase4-register-ir.md
require_file docs/adr/0018-phase4-vm-dispatch.md
require_file docs/adr/0019-phase4-runtime-value-representation.md
require_file docs/adr/0020-phase4-array-mvp.md
require_file docs/adr/0021-phase4-object-mvp.md
require_file docs/adr/0022-phase4-exception-model.md
require_file docs/adr/0023-phase4-include-model.md
require_file docs/adr/0024-phase4-known-gap-policy.md
...
require_file crates/php_runtime/src/todo_phase4.rs
...
require_file fixtures/runtime/invalid/functions/by-ref-capture.php
...
require_file fixtures/runtime/known_gaps/generators/yield.php
...
require_file fixtures/runtime/known_gaps/references/by-ref-param.php
require_file fixtures/runtime/known_gaps/references/by-ref-return.php
require_file fixtures/runtime/known_gaps/references/array-element-ref.php
require_file fixtures/runtime/known_gaps/superglobals/globals-alias.php
...
require_file prompts/phase4/README.md

require_grep 'FetchDim' docs/phase4-ir.md
require_grep 'AssignDim' docs/phase4-ir.md
require_grep 'ReferenceCell' docs/phase4-runtime-values.md
require_grep 'Include Execution' docs/phase4-vm.md
require_grep 'normalize_runtime_stderr' docs/phase4-reference-diff.md
require_grep 'phase5' docs/phase4-known-gaps.md
require_grep 'Feature Matrix' docs/handoff-phase5.md
require_grep 'Top 20 Reference Deviations' docs/handoff-phase5.md
require_grep 'Runtime/VM TODO, Unwrap, Expect, Panic Audit' docs/handoff-phase5.md
require_grep 'Phase 5 Task List' docs/handoff-phase5.md
require_grep 'Zend Opcode Mapping' docs/research/zend-opcode-mapping-phase4.md
require_grep 'does not claim Zend bytecode compatibility' docs/research/zend-opcode-mapping-phase4.md
...
printf '%s\n' '[info] Phase 4 runtime-diff remains reference-gated outside verify-phase4'
printf '%s\n' '[pass] phase4 verification complete'
