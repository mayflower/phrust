...
FIXTURE="tests/fixtures/phase7/regressions/polymorphic-method-property-ic.php"
EXPECTED="${FIXTURE}.out"
OUT_DIR="target/phase7/polymorphic-inline-cache-smoke"
...
out_dir = Path("target/phase7/polymorphic-inline-cache-smoke")
