#!/usr/bin/env python3
"""Offline framework-like Phase 7 performance smoke comparisons."""
...
DEFAULT_FIXTURES = ROOT / "tests/fixtures/phase7/framework_smoke"
DEFAULT_OUT = ROOT / "target/phase7/framework-smoke/summary.json"
