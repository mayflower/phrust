#!/usr/bin/env python3
"""Generate the Phase 7 Cranelift Big-Win benchmark matrix."""
...
DEFAULT_OUT = ROOT / "target/phase7/cranelift/big_wins_report.json"

SCENARIOS = (
    {
        "scenario": "repeated_int_function_calls",
        "target": "integer_arithmetic_leaf",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/int_arithmetic/repeated-function-call-add.php",
    ...
    },
    {
        ...
        "target": "integer_arithmetic_leaf",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/int_arithmetic/arithmetic-expression-chain.php",
        "expected_cranelift_status": "executed",
        "known_gaps": [],
    },
    {
        ...
        "target": "integer_arithmetic_leaf",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/int_arithmetic/negative-ints.php",
        "expected_cranelift_status": "executed",
        "known_gaps": [],
    },
    {
        ...
        "target": "integer_arithmetic_leaf",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/int_arithmetic/boundary-ints.php",
        "expected_cranelift_status": "executed",
        "known_gaps": [],
    },
    {
        ...
        "target": "counted_loop",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/int_arithmetic/counted-loop-accumulator.php",
        "expected_cranelift_status": "executed",
        "known_gaps": [],
    },
    {
        ...
        "target": "counted_loop",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/loops/factorial-like-loop.php",
        "expected_cranelift_status": "executed",
        "known_gaps": [],
    },
    {
        "scenario": "sum_to_n",
        "target": "counted_loop",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/loops/sum-1-to-n.php",
        "expected_cranelift_status": "executed",
        "known_gaps": [],
    },
    {
        ...
        "target": "counted_loop",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/loops/fib-iterative.php",
        "expected_cranelift_status": "executed",
        "known_gaps": [],
    },
    {
        ...
        "target": "counted_loop",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/loops/branchy-int-loop.php",
        "expected_cranelift_status": "executed",
        "known_gaps": [],
    },
    {
        ...
        "target": "branchy_int",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/loops/branchy-max-min.php",
        "expected_cranelift_status": "executed",
        "known_gaps": [],
    },
    {
        ...
        "target": "counted_loop",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/loops/non-eligible-loop-call.php",
    ...
    },
    {
        ...
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/arrays/packed-fetch-valid.php",
        "expected_cranelift_status": "executed",
    ...
    },
    {
        ...
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/arrays/packed-foreach-sum-large.php",
        "expected_cranelift_status": "executed",
        "known_gaps": [],
    },
    {
        ...
        "target": "packed_foreach_sum",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/arrays/packed-foreach-sum-mixed-element.php",
    ...
    },
    {
        ...
        "target": "packed_foreach_sum",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/arrays/packed-foreach-sum-overflow.php",
        "expected_cranelift_status": "side_exit",
    ...
    },
    {
        ...
        "target": "known_call",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/known-calls/strlen-valid.php",
        "expected_cranelift_status": "executed",
        "expected_helper_calls": 1,
        "known_gaps": [],
    },
    {
        ...
        "target": "known_call",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/known-calls/strlen-non-string.php",
        "expected_cranelift_status": "side_exit",
        "expected_side_exit_reason": "helper_status",
    ...
    },
    {
        ...
        "target": "known_call",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/known-calls/count-packed.php",
        "expected_cranelift_status": "executed",
        "expected_helper_calls": 1,
        "known_gaps": [],
    },
    {
        ...
        "target": "known_call",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/known-calls/count-mixed.php",
        "expected_cranelift_status": "executed",
        "expected_helper_calls": 1,
        "known_gaps": [],
    },
    {
        ...
        "target": "known_call",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/known-calls/strlen-wrong-arity.php",
        "expected_cranelift_status": "fallback",
        "known_gaps": [],
    },
    {
        ...
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/string-concat/two-strings.php",
        "expected_cranelift_status": "executed",
        "expected_helper_calls": 1,
        "known_gaps": [],
    },
    {
        ...
        "target": "string_concat",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/string-concat/empty-strings.php",
        "expected_cranelift_status": "executed",
        "expected_helper_calls": 1,
        "known_gaps": [],
    },
    {
        ...
        "target": "string_concat",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/string-concat/large-strings.php",
        "expected_cranelift_status": "executed",
        "expected_helper_calls": 1,
        "known_gaps": [],
    },
    {
        ...
        "target": "string_concat",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/string-concat/template-loop.php",
        "expected_cranelift_status": "executed",
    ...
    },
    {
        ...
        "target": "string_concat",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/string-concat/string-int-slow.php",
        "expected_cranelift_status": "fallback",
        "known_gaps": [],
    },
    {
        ...
        "target": "string_concat",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/string-concat/object-to-string-slow.php",
        "expected_cranelift_status": "fallback",
        "known_gaps": [],
    },
    {
        ...
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/property-load/simple-dto-property-read.php",
        "expected_cranelift_status": "executed",
        "expected_helper_calls": 1,
        "known_gaps": [],
    },
    {
        ...
        "target": "property_load",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/property-load/repeated-property-read-loop.php",
        "expected_cranelift_status": "executed",
        "expected_helper_calls": 64,
        "known_gaps": [],
    },
    {
        ...
        "target": "property_load",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/property-load/wrong-class-side-exit.php",
        "expected_cranelift_status": "side_exit",
    ...
    },
    {
        ...
        "target": "property_load",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/property-load/hook-magic-fallback.php",
        "expected_cranelift_status": "fallback",
        "known_gaps": [],
    },
    {
        ...
        "target": "property_load",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/property-load/uninitialized-error-path.php",
        "expected_cranelift_status": "side_exit",
        "expected_side_exit_reason": "guard_failed",
    ...
    },
    {
        ...
        "target": "method_call",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/method-call/service-dto-loop.php",
        "expected_cranelift_status": "executed",
        "known_gaps": [],
    },
    {
        ...
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/native/return-42.php",
        "expected_cranelift_status": "fallback",
    ...
    },
    {
        ...
        "target": "integer_arithmetic_leaf",
        "fixture": ROOT / "tests/fixtures/phase7/cranelift/int_arithmetic/overflow-correctness.php",
        "expected_cranelift_status": "side_exit",
        "known_gaps": [],
    },
)
    ...
    env.update(
        {
            ...
            "TMP": str(tmp_dir),
            "TEMP": str(tmp_dir),
            "PHRUST_RANDOM_SEED": "phase7-cranelift-bench-matrix",
            "RUST_TEST_SEED": "phase7-cranelift-bench-matrix",
        }
    )
    return env
...
def main() -> int:
    ...
    for scenario in SCENARIOS:
        ...
        for warmup_index in range(warmups):
            run_engine(
                ...
                fixture,
                "off",
                ROOT / "target/phase7/cranelift/bench-matrix-tmp" / name / "warmup-off" / str(warmup_index),
                args.timeout,
                scenario,
            )
            run_engine(
                ...
                fixture,
                "cranelift",
                ROOT / "target/phase7/cranelift/bench-matrix-tmp" / name / "warmup-cranelift" / str(warmup_index),
                args.timeout,
                scenario,
            )
        off_runs = [
            run_engine(
                ...
                fixture,
                "off",
                ROOT / "target/phase7/cranelift/bench-matrix-tmp" / name / "off" / str(index),
                args.timeout,
                scenario,
            )
        ...
        cranelift_runs = [
            run_engine(
                ...
                fixture,
                "cranelift",
                ROOT / "target/phase7/cranelift/bench-matrix-tmp" / name / "cranelift" / str(index),
                args.timeout,
                scenario,
            )
            for index in range(repeats)
        ...
        if reference_php is not None and not args.smoke:
            reference = run_reference(
                reference_php,
                fixture,
                ROOT / "target/phase7/cranelift/bench-matrix-tmp" / name / "reference_php",
                args.timeout,
            )
            rows.append(
                reference_row_for(
    ...
    report = {
        "schema_version": 2,
        "run_id": "phase7-cranelift-bench-smoke" if args.smoke else "phase7-cranelift-local",
