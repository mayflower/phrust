...
OUT_DIR="target/phase7/inline-cache-smoke"
FIXTURE_DIRS=(
    "tests/fixtures/phase7/perf_smoke"
    "tests/fixtures/phase7/inline_cache"
)
...
out_dir = Path("target/phase7/inline-cache-smoke")
