#!/usr/bin/env python3
"""Compare two Phase 7 PerfReport JSON files."""
...
DEFAULT_CURRENT = ROOT / "target/phase7/bench-phase7-smoke.json"
DEFAULT_MARKDOWN = ROOT / "target/phase7/perf-compare.md"
DEFAULT_JSON = ROOT / "target/phase7/perf-compare.json"
SELF_TEST_BASELINE = ROOT / "tests/fixtures/phase7/perf_compare/baseline.json"
SELF_TEST_CURRENT = ROOT / "tests/fixtures/phase7/perf_compare/current.json"
...
def run_self_test() -> int:
    ...
    assert summary["missing_in_current"] == ["phase7.perf_smoke.rust-vm.missing"], summary
    assert summary["added_in_current"] == ["phase7.perf_smoke.rust-vm.added"], summary
    assert summary["hard_regressions"] == 1, result
    assert code == 2, code
    markdown = render_markdown(result)
    assert "Phase 7 Performance Comparison" in markdown
