...
OUT_DIR="target/phase7/callgrind"
mkdir -p "$OUT_DIR"
rm -f "$OUT_DIR"/*

write_skip() {
    local reason="$1"
    printf '[skip] phase7 callgrind smoke: %s\n' "$reason"
...
SCENARIOS=(
    "loops:tests/fixtures/phase7/perf_smoke/loops.php"
    "function_calls:tests/fixtures/phase7/perf_smoke/function_calls.php"
    "arrays_packed:tests/fixtures/phase7/perf_smoke/arrays_packed.php"
)
...
printf '[pass] phase7 callgrind smoke measured %s scenario(s)\n' "${#SCENARIOS[@]}"
