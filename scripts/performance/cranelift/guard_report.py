...
DEFAULT_OUT = ROOT / "target/performance/cranelift/guard-report.json"
DEFAULT_FIXTURE = ROOT / "tests/fixtures/performance/cranelift/side-exit/helper-status-overflow.php"
DEFAULT_BLACKLIST_FIXTURE = ROOT / "tests/fixtures/performance/cranelift/side-exit/unstable-type-switch.php"
DEFAULT_PACKED_VALID_FIXTURE = ROOT / "tests/fixtures/performance/cranelift/arrays/packed-fetch-valid.php"
DEFAULT_PACKED_BOUNDS_FIXTURE = ROOT / "tests/fixtures/performance/cranelift/arrays/packed-fetch-out-of-bounds.php"
DEFAULT_PACKED_LAYOUT_FIXTURE = ROOT / "tests/fixtures/performance/cranelift/arrays/packed-fetch-mixed-array.php"
DEFAULT_PACKED_STRING_KEY_FIXTURE = ROOT / "tests/fixtures/performance/cranelift/arrays/packed-fetch-string-key.php"
DEFAULT_PROPERTY_VALID_FIXTURE = ROOT / "tests/fixtures/performance/cranelift/property-load/simple-dto-property-read.php"
DEFAULT_PROPERTY_WRONG_CLASS_FIXTURE = ROOT / "tests/fixtures/performance/cranelift/property-load/wrong-class-side-exit.php"
DEFAULT_PROPERTY_HOOK_MAGIC_FIXTURE = ROOT / "tests/fixtures/performance/cranelift/property-load/hook-magic-fallback.php"
DEFAULT_PROPERTY_UNINITIALIZED_FIXTURE = ROOT / "tests/fixtures/performance/cranelift/property-load/uninitialized-error-path.php"
    ...
    env.update(
        {
            ...
            "TMP": str(tmp_dir),
            "TEMP": str(tmp_dir),
            "PHRUST_RANDOM_SEED": "performance-cranelift-guard-report",
            "RUST_TEST_SEED": "performance-cranelift-guard-report",
        }
    )
    return env
...
def main() -> int:
    ...
    off = run_engine(
        ...
        args.fixture,
        "off",
        ROOT / "target/performance/cranelift/guard-report-tmp/off",
        args.timeout,
    )
    cranelift = run_engine(
        ...
        args.fixture,
        "cranelift",
        ROOT / "target/performance/cranelift/guard-report-tmp/cranelift",
        args.timeout,
    )
    blacklist = run_engine(
        ...
        "cranelift",
        ROOT / "target/performance/cranelift/guard-report-tmp/blacklist",
        args.timeout,
    )
    blacklist_off = run_engine(
        ...
        args.blacklist_fixture,
        "off",
        ROOT / "target/performance/cranelift/guard-report-tmp/blacklist-off",
        args.timeout,
    )
    packed_valid_off = run_engine(
        ...
        "off",
        ROOT / "target/performance/cranelift/guard-report-tmp/packed-valid-off",
        args.timeout,
    )
    packed_valid = run_engine(
        ...
        args.packed_valid_fixture,
        "cranelift",
        ROOT / "target/performance/cranelift/guard-report-tmp/packed-valid",
        args.timeout,
    )
    packed_bounds_off = run_engine(
        ...
        "off",
        ROOT / "target/performance/cranelift/guard-report-tmp/packed-bounds-off",
        args.timeout,
    )
    packed_bounds = run_engine(
        ...
        args.packed_bounds_fixture,
        "cranelift",
        ROOT / "target/performance/cranelift/guard-report-tmp/packed-bounds",
        args.timeout,
    )
    packed_layout_off = run_engine(
        ...
        "off",
        ROOT / "target/performance/cranelift/guard-report-tmp/packed-layout-off",
        args.timeout,
    )
    packed_layout = run_engine(
        ...
        args.packed_layout_fixture,
        "cranelift",
        ROOT / "target/performance/cranelift/guard-report-tmp/packed-layout",
        args.timeout,
    )
    packed_string_key_off = run_engine(
        ...
        "off",
        ROOT / "target/performance/cranelift/guard-report-tmp/packed-string-key-off",
        args.timeout,
    )
    packed_string_key = run_engine(
        ...
        args.packed_string_key_fixture,
        "cranelift",
        ROOT / "target/performance/cranelift/guard-report-tmp/packed-string-key",
        args.timeout,
    )
    property_valid_off = run_engine(
        ...
        "off",
        ROOT / "target/performance/cranelift/guard-report-tmp/property-valid-off",
        args.timeout,
    )
    property_valid = run_engine(
        ...
        args.property_valid_fixture,
        "cranelift",
        ROOT / "target/performance/cranelift/guard-report-tmp/property-valid",
        args.timeout,
    )
    property_wrong_class_off = run_engine(
        ...
        "off",
        ROOT / "target/performance/cranelift/guard-report-tmp/property-wrong-class-off",
        args.timeout,
    )
    property_wrong_class = run_engine(
        ...
        args.property_wrong_class_fixture,
        "cranelift",
        ROOT / "target/performance/cranelift/guard-report-tmp/property-wrong-class",
        args.timeout,
    )
    property_hook_magic_off = run_engine(
        ...
        "off",
        ROOT / "target/performance/cranelift/guard-report-tmp/property-hook-magic-off",
        args.timeout,
    )
    property_hook_magic = run_engine(
        ...
        args.property_hook_magic_fixture,
        "cranelift",
        ROOT / "target/performance/cranelift/guard-report-tmp/property-hook-magic",
        args.timeout,
    )
    property_uninitialized_off = run_engine(
        ...
        "off",
        ROOT / "target/performance/cranelift/guard-report-tmp/property-uninitialized-off",
        args.timeout,
    )
    property_uninitialized = run_engine(
        ...
        args.property_uninitialized_fixture,
        "cranelift",
        ROOT / "target/performance/cranelift/guard-report-tmp/property-uninitialized",
        args.timeout,
    )
