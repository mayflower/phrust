...
DEFAULT_INPUT = ROOT / "target/performance/cranelift/big_wins_report.json"
DEFAULT_OUT = ROOT / "target/performance/cranelift/guard-report.json"
DEFAULT_TEXT_OUT = ROOT / "target/performance/cranelift/guard-report.txt"
MINIMIZER = ROOT / "scripts/minimize_runtime_failure.py"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--minimize-dir",
        type=Path,
        default=ROOT / "target/performance/cranelift/minimized",
