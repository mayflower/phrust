#!/usr/bin/env python3
"""Generate the Phase 6 preflight inventory."""
...
def main() -> int:
    ...
    parser.add_argument("--out", default="target/phase6/preflight.json")
    args = parser.parse_args()

    targets = just_targets()
    required_phase_targets = [f"verify-phase{i}" for i in range(0, 6)]
    phase6_targets = [
        "verify-phase6",
        "test-phase6",
        "coverage-phase6",
    ...
    docs = [
        "docs/phase6-preflight.md",
        "docs/phase6-standard-library.md",
        "docs/extension-coverage-phase6.md",
        "docs/composer-compatibility-phase6.md",
        "docs/security-capabilities-phase6.md",
        "docs/known-gaps-phase6.md",
    ]
    known_gap_docs = [
        "docs/phase4-known-gaps.md",
        "docs/phase5-known-gaps.md",
        "docs/known-gaps-phase6.md",
    ]
    report = {
        "phase": 6,
        ...
        "required_phase_targets": {
            target: target in targets for target in required_phase_targets
        },
        "phase6_targets": {target: target in targets for target in phase6_targets},
