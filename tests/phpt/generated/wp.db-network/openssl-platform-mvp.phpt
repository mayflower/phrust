...
var_dump(function_exists("openssl_decrypt"));
...
var_dump(defined("OPENSSL_RAW_DATA"));
var_dump(defined("OPENSSL_ZERO_PADDING"));
var_dump(defined("OPENSSL_DONT_ZERO_PAD_KEY"));
?>
--EXPECT--
bool(true)
bool(true)
