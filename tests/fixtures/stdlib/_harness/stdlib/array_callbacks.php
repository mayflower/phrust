<?php
// stdlib-diff: id=STDLIB_ARRAY_CALLBACKS area=stdlib expect=pass
function stdlib_plus_one($value) { return $value + 1; }
class StdlibScale { static function double($value) { return $value * 2; } }

$input = ["a" => 1, "b" => 2, "c" => 3];
echo var_export(array_map("stdlib_plus_one", $input), true), "\n";
echo var_export(array_map(["StdlibScale", "double"], [1, 2]), true), "\n";
