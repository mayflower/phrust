...
use jit_abi::{
    ...
    jit_native_function_resolve_abi, jit_native_fwrite_abi, jit_native_interface_exists_abi,
    ...
    jit_native_local_store_abi, jit_native_method_exists_abi, jit_native_object_class_name_abi,
    jit_native_object_clone_abi, jit_native_object_clone_with_abi, jit_native_object_new_abi,
    jit_native_plain_object_clone_abi, jit_native_preg_filter_abi, jit_native_preg_grep_abi,
