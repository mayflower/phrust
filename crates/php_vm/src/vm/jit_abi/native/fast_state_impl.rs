...
impl NativeRequestFastState {
    ...
    fn publish_direct_strtr_map(&mut self, subject: i64, replacements: i64) -> Option<i64> {
        ...
        self.try_publish_direct_string_with(output_length, |output| {
            #[allow(unsafe_code)]
            // Safety: the subject, replacement descriptors, and FastState
            // remain request-owned and stable while publication writes into
            // a disjoint freshly reserved string range.
            let rendered = unsafe {
